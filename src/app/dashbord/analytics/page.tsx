...
export default function AnalyticsPage() {
  ...
  const categoryBreakdown = [
    { name: "AC Servicing & Repair", percentage: 42, color: "bg-rose-500", count: "348 Bookings" },
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-3 duration-200">
      ...
      <div>
        ...
        <p className="text-slate-500 mt-1">Detailed statistical insights regarding bookings, regional demand, and category metrics.</p>
      </div>
              ...
              <div key={i} className="space-y-1.5">
                <div className="flex justify-between items-center text-xs font-semibold text-slate-700">
                  ...
                  <div className="flex gap-2">
                    ...
                    <span className="text-rose-500">{cat.percentage}%</span>
                  </div>
                </div>
